...
## Project Structure
    ...
    ├── enochtestapp_dev_23893  # Django project configurations
...
1. Clone this repo and `cd enochtestapp_dev_23893`
...
2. Clone this repo and `cd enochtestapp_dev_23893`
